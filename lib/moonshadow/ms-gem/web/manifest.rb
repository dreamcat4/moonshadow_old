...
class Web < Moonshadow::Manifest
  ...
  def apache_stack
    ...
    require "shared/apache"
    include Moonshadow::Manifest::Apache
    recipe :apache_server
    # Apache::recipe :apache_server
    ...
    recipe :rails_rake_environment, :rails_gems, :rails_directories, :db_bootstrap, :rails_migrations, :rails_logrotate
