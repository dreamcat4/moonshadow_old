...
Gem::Specification.new do |s|
  ...
  s.files = [
    "app_generators/moonshine/moonshine_generator.rb",
     ...
     "app_generators/moonshine/templates/deploy.rb",
     "app_generators/moonshine/templates/gems.yml",
     "app_generators/moonshine/templates/moonshine.rake",
     "app_generators/moonshine/templates/moonshine.rb",
     "app_generators/moonshine/templates/moonshine.yml",
